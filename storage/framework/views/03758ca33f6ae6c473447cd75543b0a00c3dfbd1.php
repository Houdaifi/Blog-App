...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-12 gap-6 p-8">
        ...
        <div class="row-span-2 flex items-end flex-col">
            <div>
            <?php $__currentLoopData = $likes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $liker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $__currentLoopData = $likes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $liker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white w-6/6 h-40 p-4 shadow-md mb-5 ">
                    <div class="flex justify-between">
                        <h3 class="font-bold text-gray-700 uppercase "><?php echo e($liker); ?> has liked your post</h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PostyAPP\resources\views/dashboard.blade.php ENDPATH**/ ?>