...
<?php $__env->startSection('content'); ?>
   <div class="flex justify-center pt-6">
      <div class="bg-white w-4/12 p-6 rounded-lg">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" class="pt-6">
            <?php echo csrf_field(); ?>

            <?php if(session('status')): ?>
                <p class="text-red-500 text-sm mb-2"><?php echo e(session('status')); ?></p>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PostyAPP\resources\views/auth/login.blade.php ENDPATH**/ ?>